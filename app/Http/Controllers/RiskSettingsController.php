...
class RiskSettingsController extends Controller
{
    ...
    public function update(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'max_payout_3_toad'   => 'required|numeric|min:0',
            'max_payout_3_bottom' => 'required|numeric|min:0',
            ...
            'rate_3_bottom'       => 'required|numeric|min:0',
        ...
        try {
            ...
            Setting::set('max_payout_3_digit',  $request->max_payout_3_digit,  'decimal', 'ยอดจ่ายสูงสุดต่อเลข 3 ตัวตรง (บาท)', 'risk');
            Setting::set('max_payout_3_toad',   $request->max_payout_3_toad,   'decimal', 'ยอดจ่ายสูงสุดต่อเลข 3 ตัวโต๊ด (บาท)', 'risk');
            Setting::set('max_payout_3_bottom', $request->max_payout_3_bottom, 'decimal', 'ยอดจ่ายสูงสุดต่อเลข 3 ตัวล่าง (บาท)', 'risk');
            ...
            Setting::set('rate_3_bottom', $request->rate_3_bottom, 'decimal', 'อัตราจ่าย 3 ตัวล่าง', 'payout');
